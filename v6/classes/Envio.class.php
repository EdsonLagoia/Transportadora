    ...
    public function __construct($idenvio = false){
      if($idenvio){
        ...
        foreach($stmt as $registro){
          $this->setPeso($registro['idenvio']);
          $this->setIdremetentepk($registro['idremetentepk']);
          $this->setIdmercadoria($registro['idmercadoriapk']);
          $this->setMercadoria($registro['iddestinatariopk']);
          $this->setFragil($registro['tipoenvio']);
        }
      }
    }
